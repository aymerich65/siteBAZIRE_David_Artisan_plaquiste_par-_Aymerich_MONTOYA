<?php
ob_start();
$titrePage = "BAZIRE David artisan plaquiste - Prestations";
?>

<div class="prestationsstyle">
<h1 class="prestationsstyleh1">Mes prestations</h1>
...
<h2 class="prestationsstyleh2" >Menuiseries</h2>

<p>Les menuiseries sont un élément clé de tout projet de construction ou de rénovation. Que vous cherchiez à installer de nouvelles portes ou fenêtres en PVC, en aluminium ou en bois, je peux vous aider à trouver la solution la mieux adaptée à vos besoins. Grâce à mon expertise et à mon expérience dans le domaine de la menuiserie, je suis en mesure de vous offrir des conseils précis pour vous aider à choisir les produits les plus adaptés à votre projet.</p>

<h2 class="prestationsstyleh2">Isolation</h2>
...
<h2 class="prestationsstyleh2" >Planchers et parquets</h2>
