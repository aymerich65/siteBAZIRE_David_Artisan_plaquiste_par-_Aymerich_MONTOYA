      ...
      <div class="bloctextcontact">
         ...
         <div class="">
            <p class="">Contact par e-mail:
               <a class="ancremail" href="mailto:baziredavid88@gmail.com">Cliquez ici<svg xmlns="http://www.w3.org/2000/svg"   fill="currentColor" class="  bi bi-envelope " viewBox="0 0 16 16">
